...
int 
str8_contains(string_t string, string_t match)
{
...
usize 
str8_index_of_first(string_t string, string_t match)
{
    if (match.len > string.len) return -1;
...
string_t 
str8_trim_start(string_t string)
{
    usize offset = 0;
...
string_t 
substring8(string_t string, usize start, usize end)
{
    usize min = start;
    usize max = end;
...
string_list_t 
str8_split(mem_arena_t *arena, string_t string, string_t *delimiters, usize delimiter_count)
{
...
// --- Comparisons -------------------------------------------------------------
bool
str8_match(string_t string, string_t match)
{
...
bool 
str8_match_one_of(string_t string, string_t *matches, usize match_count)
{
...
bool 
str8_starts_with(string_t string, string_t prefix)
{
...
bool 
str8_ends_with(string_t string, string_t suffix)
{
...
void
str8_list_push_node(string_list_t *list, string_node_t *node)
{
...
void 
str8_list_push(mem_arena_t *arena, string_list_t *list, string_t string)
{
