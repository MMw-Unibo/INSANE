...
LDFLAGS="-lm -ldl -lpthread -Wl,--allow-multiple-definition"
DEFINES=""
...
# Compila libinterception.so (che usa libnsn.a statica)
echo "Building libinterception.so..."
$CC $CFLAGS -fPIC -shared ../src/libinterception/libinterception.c -I../src -I../include/ $DEFINES -o libinterception.so -L. -l:libnsn.a $LDFLAGS
